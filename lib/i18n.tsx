...
- Account Information: Email address, display name, and password when you create an account via email, or profile information from third-party sign-in providers (Apple ID, Google).
- Onboarding Answers: Your dating goals, preferences, relationship type sought, age range preferences, and current dating platforms used.
...
- Firebase Authentication (Google LLC): Handles identity verification. Firebase may collect certain device and usage data per its own privacy policy.
...
**3.4 Communications**
- To send transactional emails (account confirmation, purchase receipts, password resets).
...
We may share your information for any other purpose with your explicit consent.`,
    ...
    'privacy.s5.content': `We retain your personal information for as long as your account is active or as needed to provide the Service, resolve disputes, enforce our agreements, and comply with legal obligations.

- Account data: Retained while your account exists. Deleted within 30 days of account deletion request.
- Uploaded images: Processed transiently; not retained beyond the session needed to deliver your analysis results, unless you save the analysis.
...
- Purchase records: Retained for up to 7 years to comply with accounting and tax obligations.
- Log data: Retained for up to 12 months for security and debugging purposes.
- Backup data: May persist for up to 90 days in backup systems before permanent deletion.

You may request deletion of your account and personal data at any time. See Section 7 for how to exercise this right.`,
...
- Deletion: Request deletion of your personal information ("right to be forgotten"). You can delete your account in-app under Settings > Account > Delete Account.
...
To exercise California rights, contact us at support@datewise.app with the subject line "CCPA Request."
...
To exercise any privacy right, email us at support@datewise.app. We will respond within 30 days (or 45 days for complex requests).`,
...
If you are a parent or guardian and believe your child under 13 has provided us with personal information, please contact us immediately at support@datewise.app. We will promptly delete such information from our systems.
...
We receive and store: transaction identifiers, purchase timestamps, product purchased, and subscription status. This information is used to unlock premium features and maintain your account history.
...
**No Human Review**
Our team does not read your private messages, conversations, or personal profile content. AI processing is fully automated. Support staff may access account metadata (not conversation content) to resolve technical issues.
...
**DateWise Support**
Email: support@datewise.app
Subject: Privacy Inquiry

We are committed to resolving privacy concerns promptly and will respond to all inquiries within 30 business days.

For urgent data security concerns or potential breaches, please email support@datewise.app with the subject line "URGENT: Security Concern."`,
...
- You must not have been previously banned or removed from the Service by us.

By using the Service, you represent and warrant that you meet all eligibility requirements.`,

    'terms.s4.title': '4. User Accounts & Responsibilities',
    'terms.s4.content': `**4.1 Account Creation**
You may create a DateWise account using your email address, Apple ID, or Google account. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.

**4.2 Account Security**
- You must immediately notify us at support@datewise.app of any unauthorized access to or use of your account.
- You are responsible for all actions taken under your account, whether authorized by you or not.
- We are not liable for any loss or damage arising from your failure to maintain account security.

**4.3 Account Information**
- You agree to provide accurate, truthful, and current information.
- You agree to promptly update your information to keep it accurate.
...
You may not create multiple accounts. Creating duplicate accounts may result in all accounts being suspended or terminated.

**4.5 Account Termination**
You may delete your account at any time through Settings > Account > Delete Account. Upon deletion, your data will be removed per our Privacy Policy. We reserve the right to suspend or terminate accounts that violate these Terms.`,
...
- Creating accounts for commercial purposes without our written consent.
...
**5.4 Consequences**
Violation of this Section may result in immediate suspension or termination of your account, forfeiture of unused Sparks and subscription time, and potential legal action where applicable.`,

    'terms.s6.title': '6. Subscriptions, Sparks & Payments',
    'terms.s6.content': `**6.1 Free Tier**
DateWise offers a free tier with limited access to core features. Free users receive a limited number of Sparks upon registration to try premium features.
...
- Sparks are non-transferable and tied to your account.
- Unused Sparks expire if your account is inactive for 12 consecutive months.
- Sparks are forfeited upon account deletion.
...
**8.2 Your Content**
You retain ownership of content you upload to the Service (photos, text, conversation excerpts). By uploading content, you grant DateWise a limited, non-exclusive, royalty-free license to process and analyze that content solely for the purpose of delivering the Service to you. This license terminates when you delete the content or your account.
...
The Privacy Policy is incorporated into these Terms by reference and forms part of this agreement. Please review our Privacy Policy at datewise.app/privacy.`,
...
Your continued use of the Service after the effective date of any changes constitutes your binding acceptance of the revised Terms. If you do not agree to the revised Terms, you must stop using the Service and may delete your account.
...
We will not be liable for any failure or delay in performance due to circumstances beyond our reasonable control.`,
    ...
    'delete.method2.step1': 'Send an email to support@datewise.app',
    ...
    'delete.contact': 'Questions? Contact us at support@datewise.app',
  },
...
- Thông tin tài khoản: Địa chỉ email, tên hiển thị và mật khẩu.
- Câu trả lời onboarding: Mục tiêu hẹn hò, sở thích và các nền tảng hẹn hò đang sử dụng.
- Hình ảnh tải lên: Ảnh hồ sơ và ảnh chụp màn hình bạn tải lên để phân tích.
...
- Firebase Authentication: Xử lý xác minh danh tính.
- RevenueCat: Quản lý đăng ký và xác minh mua hàng trong ứng dụng.
- OpenAI API: Chúng tôi gửi nội dung của bạn đến API OpenAI để tạo ra các đầu ra huấn luyện AI.`,
...
**3.4 Truyền thông**
- Gửi email giao dịch và thông báo dịch vụ.`,
...
- Firebase/Google Cloud: Hạ tầng đám mây và xác thực.
...
Chúng tôi có thể tiết lộ thông tin nếu pháp luật yêu cầu.`,
    ...
    'privacy.s5.content': `Chúng tôi lưu trữ thông tin cá nhân của bạn miễn là tài khoản của bạn còn hoạt động.

- Dữ liệu tài khoản: Được xóa trong vòng 30 ngày kể từ khi yêu cầu xóa.
- Hình ảnh tải lên: Được xử lý thoáng qua, không lưu trữ vĩnh viễn.
- Đoạn trích hội thoại: Được xử lý bởi AI, không được lưu trữ vĩnh viễn.
- Hồ sơ mua hàng: Được lưu trữ tối đa 7 năm.`,
...
- Xóa: Yêu cầu xóa thông tin cá nhân.
...
Để thực hiện bất kỳ quyền bảo mật nào, hãy gửi email cho chúng tôi tại support@datewise.app.`,
...
Tất cả giao dịch thanh toán được xử lý bởi Apple (App Store) hoặc Google (Google Play). Chúng tôi không trực tiếp thu thập hoặc lưu trữ thông tin thẻ tín dụng của bạn.

Đăng ký Pro tự động gia hạn trừ khi được hủy ít nhất 24 giờ trước khi kết thúc kỳ thanh toán hiện tại.`,
...
Nhóm của chúng tôi không đọc tin nhắn riêng tư hoặc nội dung hồ sơ cá nhân của bạn. Xử lý AI hoàn toàn tự động.`,

    'privacy.s11.title': '11. Thay Đổi Chính Sách Này',
    'privacy.s11.content': `Chúng tôi có thể cập nhật Chính Sách Bảo Mật này theo thời gian. Khi chúng tôi thực hiện các thay đổi quan trọng, chúng tôi sẽ cập nhật ngày "Cập nhật lần cuối" và gửi thông báo trong ứng dụng.`,
...
- Người dùng từ 13 đến 17 tuổi chỉ có thể sử dụng với sự đồng ý của cha mẹ hoặc người giám hộ hợp pháp.
- Dịch vụ không dành cho bất kỳ ai dưới 13 tuổi.
- Bạn phải cung cấp thông tin chính xác, hiện tại và đầy đủ khi tạo tài khoản.`,

    'terms.s4.title': '4. Tài Khoản Người Dùng & Trách Nhiệm',
    'terms.s4.content': `**4.1 Tạo tài khoản**
Bạn có thể tạo tài khoản DateWise bằng địa chỉ email, Apple ID hoặc tài khoản Google.

**4.2 Bảo mật tài khoản**
Bạn chịu trách nhiệm duy trì tính bảo mật của thông tin đăng nhập tài khoản và cho tất cả các hoạt động xảy ra dưới tài khoản của bạn.

**4.3 Thông tin tài khoản**
Bạn đồng ý cung cấp thông tin chính xác, trung thực và hiện tại.

**4.4 Một tài khoản mỗi người**
Bạn không được tạo nhiều tài khoản.`,
...
DateWise cung cấp gói miễn phí với quyền truy cập hạn chế vào các tính năng cốt lõi.

**6.2 Sparks (Tín dụng tiêu dùng)**
Sparks là tín dụng tiêu dùng trong ứng dụng được sử dụng để truy cập các tính năng AI.
- Sparks không có giá trị tiền mặt và không được hoàn tiền sau khi mua.
- Sparks không thể chuyển nhượng và gắn với tài khoản của bạn.
...
Tất cả các giao dịch mua là chính thức. Yêu cầu hoàn tiền phải được gửi qua nền tảng tương ứng (Apple hoặc Google).`,
...
Đầu ra huấn luyện AI không thay thế cho lời khuyên tâm lý, trị liệu hoặc quan hệ chuyên nghiệp.`,
    ...
    'terms.s8.content': `Dịch vụ, bao gồm nội dung gốc, tính năng, chức năng, thiết kế, phần mềm và thương hiệu, thuộc sở hữu của DateWise và được bảo vệ bởi luật sở hữu trí tuệ.

Bạn giữ quyền sở hữu nội dung bạn tải lên Dịch vụ. Bằng cách tải lên nội dung, bạn cấp cho DateWise giấy phép hạn chế để xử lý và phân tích nội dung đó chỉ nhằm mục đích cung cấp Dịch vụ cho bạn.`,
...
Chính Sách Bảo Mật được tích hợp vào các Điều Khoản này bằng cách tham chiếu. Vui lòng xem lại Chính Sách Bảo Mật tại datewise.app/privacy.`,
...
Đối với các vấn đề không thuộc trọng tài, bạn đồng ý với thẩm quyền riêng biệt của các tòa án tiểu bang và liên bang tại Quận Santa Clara, California.`,
    ...
    'terms.s14.content': `Chúng tôi bảo lưu quyền sửa đổi các Điều Khoản này bất cứ lúc nào. Khi chúng tôi thực hiện các thay đổi quan trọng, chúng tôi sẽ cập nhật ngày "Cập nhật lần cuối" và cung cấp thông báo nổi bật trong ứng dụng.

Việc tiếp tục sử dụng Dịch vụ sau ngày có hiệu lực của bất kỳ thay đổi nào cấu thành sự chấp nhận ràng buộc của bạn đối với các Điều Khoản đã sửa đổi.`,
...
Nếu bất kỳ điều khoản nào được tìm thấy không thể thực thi, các điều khoản còn lại sẽ vẫn có hiệu lực đầy đủ.`,
    ...
    'delete.method2.step1': 'Gửi email đến support@datewise.app',
    ...
    'delete.contact': 'Câu hỏi? Liên hệ chúng tôi tại support@datewise.app',
  }
}
